  ...
  <div class="container mx-auto flex justify-center align-center flex-col rounded my-100 shadow-md bg-gray-50">
    <div class="container flex flex-col items-center">
        ...
        <div class="flex flex-col justify-center w-58 shadow-md m-5 hover:scale-110 bg-white space-y-15 border rounded">
          ...
          <p class="datosUtiles text-zinc-600 ">La receta con mas ingredientes es: <span class="font-bold"><?php echo isset($caro) ? $caro : ''; ?></span></p>
          <p class="datosUtiles text-zinc-600 ">La receta mas cara por personas es: <span class="font-bold"><?php echo isset($barato) ? $barato : ''; ?></span></p>
          <p class="datosUtiles text-zinc-600 ">El costo por persona de la receta mas cara es: <span class="font-bold">$<?php echo isset($total) ? $total : ''; ?></span></p>
          </div>
        </div>
    </div>
    <div id="divNuevoIngrediente" class="flex flex-col lg:w-full align-center justify-center items-center">
      <div  class="flex flex-col align-center justify-center">
      <button id="nuevoIngrediente" type="submit" class="m-1 px-4 py-1 text-sm font-semibold bg-gray-100 rounded border border-black-200 hover:text-white hover:bg-gray-400 focus:outline-none" onclick="">Nueva Receta</button>
      </div>
              ...
              <div class="flex flex-col justify-center items-center">
                <div class="flex text-start">
                  ...
                  <div class="text-center w-2/4"><input id="unidadDeMedidaNuevo" value="" name="unidadDeMedida"
                      type="text"
                      class="w-3/4 h-5 border border-transparent border-b-black focus:outline-none text-xs text-center ml-2"
                      placeholder="Unidad de Medida"><br><span>$</span><input id="precioNuevo" value="" name="precio"
                      type="number"
    ...
    <div class="flex flex-row items-center justify-center align-center">
      <div clas="w-1/2">
      ...
      <h2 class="text-s mx-2 ">
        <input id="'.$value['nombre'].'" class="w-full text-center" value="'.$value['nombre'].'" name="nombre" disabled></input>
      </h2>
      </div>
    </div>
    <div class="flex flex-row items-center">
      <div class="flex flex-col justify-center items-center">
        <div class="flex text-start">
          ...
          <div class="text-center w-2/4">
            <input id="cantidad'.$value['nombre'].'" value="'.$value['unidadDeMedida'].'" name="unidadDeMedida" type="text" class="w-3/4 h-5 border border-transparent border-b-black focus:outline-none text-xs text-center ml-2" disabled><br>
